  ...
  return (
    <div className='section container'>
      <div className='section-title'>
        ...
        <p>
          Welcome to the website(http://progcc.org/). By using this website, you
          will be deemed to have accepted the following conditions. If you
          disagree with these conditions, please do not enter this site.
        </p>
      </div>
      <ul>
        <li className='termcondition'>
          This site belongs to Akventure Group of companies UAE, and some of the
          information on the site is published by the Association. Some of it is
          provided by the Association from other sources.
        </li>
        <li className='termcondition'>
          ...
          information is correct, sufficient, and complete, and declares that it
          does not accept responsibility for viruses, deficiencies and/or errors
          in this information.
        </li>
        <li className='termcondition'>
        ...
        <li className='termcondition'>
          ...
          published by the relevant institutions and does not bind the Akventure
          Group of companies UAE.
        </li>
        <li className='termcondition'>
          Studies published on our website may be published without permission
          by showing the source, but the commercial purpose of this information
          is subject to the written permission of the group.
        </li>
        <li className='termcondition'>
